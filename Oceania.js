...
var imageArray = ["PapuaNewGuinea.png","Hawaii (US).png","SolomonIslands.png","Vanuatu.png","Samoa.png","Kiribati.png","FederatedStatesofMicronesia.png","AmericanSamoa(US).png","Palau.png","Nauru.png","NorfolkIsland(Australia).png","Niue(NZ).png","Tokelau(NZ).png","PitcairnIslands(UK).png","NorthernMarianaIslands.png","Guam(US).png","Fiji.png","CookIslands(NZ).png"];
